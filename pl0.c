...
int main()
{
	...
	bool nxtlev[symnum];
	printf("学号:3120005338	姓名:黄彦翔\n");
	printf("开始调试时间:2023-4-21\n结束调试时间:2023-5-10\n");
	while(!fin){
...
void init(void)
{
	...
	strcpy(&(word[13][0]),"else");	//增加一个else
	...
	wsym[11]=whilesym;
	wsym[12]=writesym;
	wsym[13]=elsesym;	//改: 添加else语句
	// wsym[14]=forsym;	//改：添加for语句
	// wsym[15]=plussbk;
	// wsym[16]=minussbk;
	// wsym[17]=plusplus;
	// wsym[18]=minusminus;
	...
	statbegsys[elsesym]=true;	//改: 添加else语句
